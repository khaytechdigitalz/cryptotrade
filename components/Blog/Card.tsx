...
const BlogCard = ({ blog }: any) => {
  ...
  return (
    <Link href={"/blog/" + blog?.post_id}>
      <div className=" tradex-cursor-pointer tradex-space-y-4 hover:tradex-shadow-[0px_2px_50px_0px_#66666626] tradex-rounded-lg tradex-border tradex-border-background-primary tradex-bg-background-main">
        <div className=" tradex-min-h-[222px]">
          <img
            className=" tradex-max-h-[222px] tradex-h-[222px] tradex-w-full tradex-rounded-tl-lg tradex-rounded-tr-lg tradex-object-cover tradex-object-center"
        ...
        <div className="tradex-space-y-4 tradex-px-2 tradex-pb-4">
          <div className=" tradex-space-y-2  tradex-max-w-[600px]">
            ...
            <h3 className=" tradex-text-2xl tradex-leading-[30px] !tradex-text-title">
              {blog?.title}
            </h3>
          </div>
          <p className=" tradex-text-base tradex-leading-[22px] tradex-text-body tradex-line-clamp-3">
            {blog?.description}
          </p>
        </div>
      </div>
