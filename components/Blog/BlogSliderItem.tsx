...
export default function BlogSliderItem({
  thumbnail,
  created_at,
  title,
  description,
  ...
  return (
    <Link href={"/blog/" + post_id}>
      <div className=" tradex-cursor-pointer tradex-grid tradex-grid-cols-1 md:tradex-grid-cols-12 tradex-gap-6">
        <div className=" md:!tradex-col-span-5">
          <img
            className=" !tradex-rounded-lg md:!tradex-h-[330px] !tradex-max-h-[330px] !tradex-w-full !tradex-object-cover !tradex-object-center"
            src={imgSrc || "./bitcoin-cryptocurrency-investing-concept.png"}
            onError={handleError}
          />
        </div>

        <div className="md:!tradex-col-span-7">
          <div className=" tradex-pt-[18px] tradex-pb-[54px] tradex-space-y-2 md:tradex-space-y-4">
            <div className=" tradex-space-y-2  tradex-max-w-[600px]">
              <div className=" tradex-flex tradex-gap-1 tradex-items-center">
                <span>
                  <svg
                    ...
                    className=" tradex-fill-primary tradex-stroke-primary"
                  >
                    <path
                ...
                <p className=" tradex-text-primary tradex-text-sm tradex-leading-[18px] tradex-font-bold">
                  {formateDateMunite(created_at)}
                </p>
              </div>
              <h1 className=" tradex-text-xl md:tradex-text-[32px] md:tradex-leading-[44px] !tradex-text-title">
                {title}
              </h1>
            </div>
            <p className=" tradex-text-xs md:tradex-text-base md:tradex-leading-[22px] tradex-text-body tradex-line-clamp-5">
              {description}
            </p>
          </div>
        </div>
